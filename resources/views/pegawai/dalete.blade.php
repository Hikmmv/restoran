...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <form action="/daletedata/{$id}" method="get" enctype="multipart/form-data">
        @csrf
            ...
            <div class="card-body">
                <table class="table">
                  ...
                  <tbody>
                    ...
                    <td>{{ $row->jabatan }}</td>
                    <td>
                      <a href="/daletedata/{$id}{{ $row->id }}" class="btn btn-danger btn-sm">Delate</a>
                      <a href="/tampilkandata/{$id}{{ $row->id }}" class="btn btn-success btn-sm">EDIT</a>
                    </td>
                  </tbody>
                    @endforeach
                </table>
